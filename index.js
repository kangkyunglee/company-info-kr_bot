...
문체 규칙:
- 명사형/개조식으로 작성. "~입니다", "~있습니다", "~하고 있습니다" 같은 서술형 금지
- 예: "케이블 전문 제조업체" (O) / "케이블을 제조하는 기업입니다" (X)
- 키워드 나열식으로 작성. 조사(은/는/이/가/을/를/의/에/로) 최소화
- 예: "반도체·스마트폰·가전 글로벌 기업" (O) / "반도체와 스마트폰, 가전을 제조하는 글로벌 기업" (X)
- 예: "HD현대중공업, 삼성중공업, 한화오션" (O) / "HD현대중공업과 삼성중공업, 한화오션에 납품" (X)
- 각 섹션 1줄 권장, 최대 2줄
- 줄바꿈 시 다음 줄 앞에 공백 6칸 들여쓰기

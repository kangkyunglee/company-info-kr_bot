...
● 실적 (2024년, 연결)
      매출 300조 / 영업이익 32조
(비상장·스타트업 등 매출 미확인 시 "매출 미공개 / 누적투자 X억" 또는 최근 투자라운드 정보로 대체)
● 이슈
      이슈1 (한 줄)
      이슈2 (한 줄)
...
- 실적은 "매출 X억 / 영업이익 X억" 이 형식만. 괄호 설명·세전이익·순이익·미공시 설명 등 추가 금지
- 영업이익을 못 찾으면 "영업이익 미확인"으로만 표기
- 적자면 "영업이익 -X억"으로 숫자 표기
- 분기실적·부연·역대기록 절대 금지
- ※, >, 참고, 주 같은 주석 절대 넣지 마
- 모든 섹션 내용은 줄바꿈 없이 한 줄로. 쉼표 앞뒤로 줄바꿈 금지
